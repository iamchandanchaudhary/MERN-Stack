...
function Navbar() {
    return (
        <section className="flex justify-between items-center w-full h-16 px-10 bg-blue-500 text-[#fff]">
            ...
            <div>
                <Link to="/main-page" className="menu hover:bg-[#fff] hover:text-[#000] px-3 py-1 rounded-md hover:drop-shadow-md transition-all duration-300 ease-in-out">Main Page</Link>
            </div>
        </section>
    );
}
