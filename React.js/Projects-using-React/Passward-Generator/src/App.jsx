...
function App() {
  ...
  return (
    <main className={`${modeChange} h-screen w-full`}>
        ...
        <div className={`absolute top-6 right-12 text-[#de2121] dark:text-white bg-[#fff] dark:bg-transparent border-2 border-[#de2121] dark:border-white px-3 py-2 rounded-full`}>
