...
function About() {
    return (
        <section className="flex flex-col items-center w-max bg-orange-200 my-8 py-12 px-20 rounded-lg">
            <h1 className="text-4xl font-bold">What makes a password strong?</h1>

            <div className="flex mt-12 gap-8">
                <div className="max-w-72 bg-[#fff] px-8 py-4 flex items-center justify-center flex-col gap-4 rounded-lg">
