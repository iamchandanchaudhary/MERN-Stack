...
function About() {
    return (
        <section className="flex flex-col items-center w-[85vw] md:w-max bg-[#fff1e6] dark:bg-[#0a1338] my-8 py-12 px-10 md:px-20 rounded-lg drop-shadow-lg">
            <h1 className="text-3xl md:text-4xl font-bold flex flex-wrap text-center">What makes a password strong?</h1>

            <div className="flex  flex-col md:flex-row mt-12 gap-6 md:gap-8">
                <div className="max-w-64 md:max-w-72 bg-[#fff] hover:bg-[#1848a1] hover:text-[#fff] dark:bg-gray-800 dark:hover:bg-[#1848a1] px-6 md:px-8 py-4 flex items-center justify-center flex-col gap-2 md:gap-4 rounded-lg drop-shadow-lg transition-all duration-500 ease-in-out">
